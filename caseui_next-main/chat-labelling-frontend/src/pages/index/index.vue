        ...
        if (response.data.background) {
          this.$refs.chatUI.addMessage({
            message: '<strong>Your Role: </strong>' + (this.role === 'sys' ? 'System. ' : 'Normal user. ') + '<br/>' +
              ...
              '<strong>Now chat starts!</strong>' + '<br/>' + 'Note: the system response may be a bit slow since multiple steps need to be taken before sending you a response, please be patient.',
            time: new Date()
          }, 'other')
          if (this.role === 'cus') {
